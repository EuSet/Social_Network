...
const Sidebar = (props) => {
    return  <div className={s.sidebar}>
        <ul>
            <li className={s.item}><NavLink to='/profile' activeClassName={s.activeLink}><img src={iconProfile}/>Profile</NavLink></li>
            <li className={s.item}><NavLink to='/dialogs' activeClassName={s.activeLink}><img src={iconMessages}/>Message</NavLink></li>
            <li className={s.item}><NavLink to='/feed' activeClassName={s.activeLink}><img src={iconNews}/>News</NavLink></li>
